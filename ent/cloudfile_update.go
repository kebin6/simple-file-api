...
func (cfu *CloudFileUpdate) SetPath(s string) *CloudFileUpdate {
	cfu.mutation.SetPath(s)
	return cfu
}

// SetNillablePath sets the "path" field if the given value is not nil.
func (cfu *CloudFileUpdate) SetNillablePath(s *string) *CloudFileUpdate {
	if s != nil {
		cfu.SetPath(*s)
	}
	return cfu
...
func (cfu *CloudFileUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := cfu.mutation.Path(); ok {
		_spec.SetField(cloudfile.FieldPath, field.TypeString, value)
	}
...
// SetPath sets the "path" field.
func (cfuo *CloudFileUpdateOne) SetPath(s string) *CloudFileUpdateOne {
	cfuo.mutation.SetPath(s)
	return cfuo
}

// SetNillablePath sets the "path" field if the given value is not nil.
func (cfuo *CloudFileUpdateOne) SetNillablePath(s *string) *CloudFileUpdateOne {
	if s != nil {
		cfuo.SetPath(*s)
	}
	return cfuo
