...
// PreviewHost applies equality check predicate on the "preview_host" field. It's identical to PreviewHostEQ.
func PreviewHost(v string) predicate.StorageProvider {
	return predicate.StorageProvider(sql.FieldEQ(FieldPreviewHost, v))
}
...
// PreviewHostEQ applies the EQ predicate on the "preview_host" field.
func PreviewHostEQ(v string) predicate.StorageProvider {
	return predicate.StorageProvider(sql.FieldEQ(FieldPreviewHost, v))
}

// PreviewHostNEQ applies the NEQ predicate on the "preview_host" field.
func PreviewHostNEQ(v string) predicate.StorageProvider {
	return predicate.StorageProvider(sql.FieldNEQ(FieldPreviewHost, v))
}

// PreviewHostIn applies the In predicate on the "preview_host" field.
func PreviewHostIn(vs ...string) predicate.StorageProvider {
	return predicate.StorageProvider(sql.FieldIn(FieldPreviewHost, vs...))
}

// PreviewHostNotIn applies the NotIn predicate on the "preview_host" field.
func PreviewHostNotIn(vs ...string) predicate.StorageProvider {
	return predicate.StorageProvider(sql.FieldNotIn(FieldPreviewHost, vs...))
}

// PreviewHostGT applies the GT predicate on the "preview_host" field.
func PreviewHostGT(v string) predicate.StorageProvider {
	return predicate.StorageProvider(sql.FieldGT(FieldPreviewHost, v))
}

// PreviewHostGTE applies the GTE predicate on the "preview_host" field.
func PreviewHostGTE(v string) predicate.StorageProvider {
	return predicate.StorageProvider(sql.FieldGTE(FieldPreviewHost, v))
}

// PreviewHostLT applies the LT predicate on the "preview_host" field.
func PreviewHostLT(v string) predicate.StorageProvider {
	return predicate.StorageProvider(sql.FieldLT(FieldPreviewHost, v))
}

// PreviewHostLTE applies the LTE predicate on the "preview_host" field.
func PreviewHostLTE(v string) predicate.StorageProvider {
	return predicate.StorageProvider(sql.FieldLTE(FieldPreviewHost, v))
}

// PreviewHostContains applies the Contains predicate on the "preview_host" field.
func PreviewHostContains(v string) predicate.StorageProvider {
	return predicate.StorageProvider(sql.FieldContains(FieldPreviewHost, v))
}

// PreviewHostHasPrefix applies the HasPrefix predicate on the "preview_host" field.
func PreviewHostHasPrefix(v string) predicate.StorageProvider {
	return predicate.StorageProvider(sql.FieldHasPrefix(FieldPreviewHost, v))
}

// PreviewHostHasSuffix applies the HasSuffix predicate on the "preview_host" field.
func PreviewHostHasSuffix(v string) predicate.StorageProvider {
	return predicate.StorageProvider(sql.FieldHasSuffix(FieldPreviewHost, v))
}

// PreviewHostEqualFold applies the EqualFold predicate on the "preview_host" field.
func PreviewHostEqualFold(v string) predicate.StorageProvider {
	return predicate.StorageProvider(sql.FieldEqualFold(FieldPreviewHost, v))
}

// PreviewHostContainsFold applies the ContainsFold predicate on the "preview_host" field.
func PreviewHostContainsFold(v string) predicate.StorageProvider {
	return predicate.StorageProvider(sql.FieldContainsFold(FieldPreviewHost, v))
}
