...
func (m *CloudFileMutation) SetPath(s string) {
	m._path = &s
}

// Path returns the value of the "path" field in the mutation.
func (m *CloudFileMutation) Path() (r string, exists bool) {
	v := m._path
	if v == nil {
		return
	}
...
// OldPath returns the old "path" field's value of the CloudFile entity.
// If the CloudFile object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *CloudFileMutation) OldPath(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
...
func (m *CloudFileMutation) ResetPath() {
	m._path = nil
}
...
func (m *CloudFileMutation) Fields() []string {
	...
	if m._path != nil {
		fields = append(fields, cloudfile.FieldPath)
	}
	if m.url != nil {
...
// SetPreviewHost sets the "preview_host" field.
func (m *StorageProviderMutation) SetPreviewHost(s string) {
	m.preview_host = &s
}

// PreviewHost returns the value of the "preview_host" field in the mutation.
func (m *StorageProviderMutation) PreviewHost() (r string, exists bool) {
	v := m.preview_host
	if v == nil {
		return
	}
...
// OldPreviewHost returns the old "preview_host" field's value of the StorageProvider entity.
// If the StorageProvider object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *StorageProviderMutation) OldPreviewHost(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldPreviewHost is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
		return v, errors.New("OldPreviewHost requires an ID field in the mutation")
	}
	oldValue, err := m.oldValue(ctx)
	if err != nil {
		return v, fmt.Errorf("querying old value for OldPreviewHost: %w", err)
	}
	return oldValue.PreviewHost, nil
}

// ResetPreviewHost resets all changes to the "preview_host" field.
func (m *StorageProviderMutation) ResetPreviewHost() {
	m.preview_host = nil
}
...
func (m *StorageProviderMutation) Fields() []string {
	...
	if m.preview_host != nil {
		fields = append(fields, storageprovider.FieldPreviewHost)
	}
	if m.folder != nil {
