...
func (spu *StorageProviderUpdate) SetPreviewHost(s string) *StorageProviderUpdate {
	spu.mutation.SetPreviewHost(s)
	return spu
}

// SetNillablePreviewHost sets the "preview_host" field if the given value is not nil.
func (spu *StorageProviderUpdate) SetNillablePreviewHost(s *string) *StorageProviderUpdate {
	if s != nil {
		spu.SetPreviewHost(*s)
	}
	return spu
}
...
func (spu *StorageProviderUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := spu.mutation.PreviewHost(); ok {
		_spec.SetField(storageprovider.FieldPreviewHost, field.TypeString, value)
	}
...
// SetPreviewHost sets the "preview_host" field.
func (spuo *StorageProviderUpdateOne) SetPreviewHost(s string) *StorageProviderUpdateOne {
	spuo.mutation.SetPreviewHost(s)
	return spuo
}

// SetNillablePreviewHost sets the "preview_host" field if the given value is not nil.
func (spuo *StorageProviderUpdateOne) SetNillablePreviewHost(s *string) *StorageProviderUpdateOne {
	if s != nil {
		spuo.SetPreviewHost(*s)
	}
	return spuo
}
...
func (spuo *StorageProviderUpdateOne) sqlSave(ctx context.Context) (_node *StorageProvider, err error) {
	...
	if value, ok := spuo.mutation.PreviewHost(); ok {
		_spec.SetField(storageprovider.FieldPreviewHost, field.TypeString, value)
	}
